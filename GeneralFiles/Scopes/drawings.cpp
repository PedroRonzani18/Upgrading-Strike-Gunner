...
void textureModule(double x, double y, GLuint z)
{
...
void textureModule(double x, double y, GLuint z, double wo, double uo, double dw, double du)
{
    GLuint aux = glGenLists(1);
...
void initializeTextures()
{
    ...
    {
        if(vec[4] == "-1")
            textureModule(stof(vec[0]), stof(vec[1]), loadTexture(stringToArray(vec[2])));
